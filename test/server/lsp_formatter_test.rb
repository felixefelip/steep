...
class Steep::Server::LSPFormatterTest < Minitest::Test
  ...
  def type_check(content)
    ...
    Services::TypeCheckService.type_check(source: source, subtyping: subtyping, constant_resolver: resolver, cursor: nil, contracts: Steep::Contracts::Store.empty, postconditions: Steep::Postconditions::Store.empty, callbacks: Steep::Callbacks::Store.empty, specializations: Steep::Specializations::Store.empty, delegation_registry: Steep::Project::DelegationRegistry.new, constructor_bindings: Steep::Project::ConstructorBindingRegistry.new, return_forwarding: Steep::Project::ReturnForwardingRegistry.new, return_alias: Steep::Project::ReturnAliasRegistry.new)
  end
